...
\begin{document}
    ...
    \author{Jayden Rodriguez Lugo, David Navarrete}
    \date{}
    \maketitle
...
\end{lstlisting}
        ...
        \ans{
            \ans{\centerfig{.8}{citiesSmall_knn_k1.png}}
        }
...
\end{lstlisting}
        ...
        %
        \ans{\centerfig{.8}{knn_q2_accuracy.png}}
        ...
        %
        \centerfig{.8}{knn_q2_training_error.png}
...
\end{lstlisting}
        ...
        \ans{\centerfig{.8}{kmeans_5.1_model.png}}
    ...
    \begin{enumerate}
        ...
        %
        \ans{\centerfig{.8}{kmeans_5.2_model.png}}
