...
\begin{document}
    ...
    \author{\textbf{Jayden Rodriguez Lugo - 1234567} and 
...
\end{lstlisting}
        ...
        \ans{\centerfig{.8}{q1_knn_boundary.png}}
...
\end{lstlisting}
        ...
        %
        \ans{\centerfig{.8}{q2_cv_test_accuracy.png}}
...
\end{lstlisting}
        ...
        \ans{\centerfig{.8}{q5_best_clustering.png}}
