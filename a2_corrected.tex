...
\begin{document}
    ...
    \author{[Student 1 Full Name] --- [Student 1 Number]\\{}[Student 2 Full Name] --- [Student 2 Number]}
    \date{}
    \maketitle
...
\end{lstlisting}
        ...
        \ans{
            \centerfig{.8}{a2/figs/q1_knn_boundary.png}
        }
...
#test accuracy
    ...
    plt.close()
\end{lstlisting}
\ans{\centerfig{.8}{a2/figs/q2_cv_test_accuracy.png}}
        ...
        %
        \ans{The best training error occurs at $k=1$ and is 0, corresponding to training accuracy 1. Its test error is 0.3500, the worst among the tested choices, illustrating that fitting the training data perfectly does not imply good generalization.}
        \centerfig{.8}{a2/figs/q2_training_error.png}
    \end{enumerate}
...
\end{lstlisting}
    ...
    \centerfig{.5}{a2/figs/kmeans_basic.png}
    ...
    \centerfig{.5}{a2/figs/kmeans_good.png}
...
\end{lstlisting}
        ...
        %
        \ans{The lowest sum of squared distances across 50 random initializations with $k=4$ was $3071.468053$ (NumPy seed 4611).}
...
plt.close()
\end{lstlisting}
        \centerfig{.8}{a2/figs/q5_best_clustering.png}
...
plt.close()
\end{lstlisting}
        \ans{\centerfig{.8}{a2/figs/q5_elbow.png}}
